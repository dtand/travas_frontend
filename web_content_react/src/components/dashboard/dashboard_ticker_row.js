  ...
  render() {
    ...
    const tickerList = this.props.tickers.map((ticker,index) =>
            <DashboardTicker key={ "ticker-" + index }
                             ...
                             forceSelect={ index === 0 && this.props.forceFirst }
                             toggleLoading={ this.props.toggleLoading } 
                             setUpdateCandles={ this.props.setUpdateCandles } 
                             candles={ this.props.candles[index] }
                             interval={ this.props.intervals[index] }
